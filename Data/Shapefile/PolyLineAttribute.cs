...
{
    /// <summary>
    /// Polylinen attribuutit DBASEIV tiedostossa.
    /// </summary>
    public class PolyLineAttribute : Attribute
    {
        ...
        public Decimal Kohdeoso { get; set; }   // N11: row_id
        public Decimal Ainlahde { get; set; }   // N11: Aineisto lähdekoodi
        public string Syntyhetki { get; set; }  // C8: Alkupvm
        public string Kuolhetki { get; set; }   // C8: Loppupvm
        public Decimal Kartoglk { get; set; }   // N11: Kartografinen luokkakoodi
        public Decimal Aluejakoon { get; set; } // N11: Osallistuu aluejakoon 0 = false, 1 = true
        public Decimal Versuh { get; set; }     // N11: Vertikaalisuhde-koodi
        ...
        public Decimal Attr2 { get; set; }      // N11
        public Decimal Attr3 { get; set; }      // N11
    }
}
