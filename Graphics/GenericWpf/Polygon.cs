...
namespace Karttailu2.Graphics.GenericWpf
{
    public partial class MapVisualiser
    {
        ...
        private void DrawPolygon(Canvas canv, Data.Generic.PolygonRecord record)
        {
            ...
            // Tehdään linkki oliosta sen recordiin.
            myPath.Uid = String.Format("{0}-{1}-{2}", "poly-", record.Id, 1);
            graphicsElements[myPath.Uid] = record;

            // Lisätään olio canvakselle

            Canvas.SetZIndex(myPath, classSetting.ZIndex);
